...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6282211991425@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE BOT BRYNZX JANGAN LUPA SAVE Btynzx, PASTI GK DI SAVEBACK' })
}
